...
def test_add_pets_with_valid_data_without_photo(name='МосяБезФото', animal_type='кот', age='3'):
...
def test_add_pet_with_four_digit_age_number(name='Ben', animal_type='cat', age='4455', pet_photo='images/Ben.jpg'):
